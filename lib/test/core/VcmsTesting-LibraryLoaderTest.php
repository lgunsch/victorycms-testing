...
class LibraryLoaderTest extends UnitTestCase
{
	...
	public function setupTempDir()
	{
		...
		$tempName = tempnam(sys_get_temp_dir(), 'libraryloader_test');
		if ($tempName === false) {
	...
	public function testInstance()
	{
		...
		$this->assertIsA($libraryloader, 'Vcms\LibraryLoader');
		$libraryloader2 = $libraryloader;
		$this->assertReference($libraryloader, $libraryloader2, 'Copy references are different');
	}
	...
	/*
	 * Test loading the external library
	 */
